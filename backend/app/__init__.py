...
@app.route("/")
def route_default():
    return "Welcome to the CrabCast Carcinization Network. All your Shells are belong to us."
...
if os.environ.get("SEED_DATA") == "True":
    ...
    for i in range(3):
        transaction_pool.set_transaction(
            Transaction(Wallet(), Wallet().address, random.randint(2, 75))
        )
