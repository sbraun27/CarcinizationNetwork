...
def test_is_valid_block_bad_difficulty(last_block, block):
    ...
    block.hash = f"{'0'*jumped_difficulty}abbbd112333"

    with pytest.raises(Exception, match="The difficulty requirement was altered by more than 1."):
        Block.is_valid_block(last_block, block)


def test_is_valid_block_bad_block_hash(last_block, block):
    block.hash = "0000000000000000000000000000000000000000000000000000bbb11234552525fff"
