class TransactionPool:
    ...
    def existing_transaction(self, address):
        """
        Find a transction generated by the address in the transaction pool.
        """
    ...
    def transaction_data(self):
        """
        Return transaction data of all transaction data in the pool. Represented in JSON serialized form.
        """
        return list(map(
